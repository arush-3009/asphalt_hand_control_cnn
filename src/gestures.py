...
class Gestures:
    ...
    def __init__(self, config):
        ...
        self.predictor = GesturePredictor(path_to_trained_model= (cnn_config.MODELS_DIR / cnn_config.MODEL_SAVE_NAME),  mean_norm=cnn_config.NORMALIZE_MEAN, std_norm=cnn_config.NORMALIZE_STD, device=cnn_config.DEVICE, img_size=cnn_config.IMG_SIZE)
